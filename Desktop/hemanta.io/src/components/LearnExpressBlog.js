...
const LearnExpressBlog = () => {
  return (
    <div className="learn-express w-full bg-gray-100 flex justify-around items-center my-10">
      <div className="w-80">
        <img src={bookCover} alt="Learn Express Book Cover" />
      </div>
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-6xl font-bold text-rose-900 my-4">
          Learn Express.js
        </h1>
        ...
        <p className="text-xl font-bold text-gray-900 mb-4">
          Build production-ready web APIs
        </p>
        <p className="text-center text-gray-500 font-bold mb-4">
...
export default LearnExpressBlog
