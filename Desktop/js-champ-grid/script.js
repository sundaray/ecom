...
**************READ ME***********
*******************************/
readMeClick = document.querySelector('.read-me-click');
readMeModal = document.querySelector('.read-me');

readMeClick.addEventListener('click', () => {
    readMeModal.style.cssText = 'opacity: 1; visibility: visible';
});

close = document.querySelector('.fa-times-circle');

close.addEventListener('click', () => {
    readMeModal.style.cssText = 'opacity: 0; visibility: hidden';
});
